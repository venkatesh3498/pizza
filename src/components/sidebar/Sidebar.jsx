            ...
            <div className="listItmes">
                ...
                <div className={activ==="settings" ? "nav-but settings activ":"nav-but settings"} onClick={()=>{setActiv("settings")}}>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                        width="30" height="30"
                        viewBox="0 0 50 50"
                        className={activ==="settings" ? "full settings activee":"full settings"}
                    >
                ...
                <div className={activ==="orders" ? "nav-but orders activ":"nav-but orders"} onClick={()=>{setActiv("orders")}}>
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                        width="30" height="30"
                        viewBox="0 0 50 50"
                        className={activ==="orders" ? "full orders activee":"full orders"}
                    >
                ...
                <div className={activ=="auth" ? "nav-but auth activ":"nav-but auth"} onClick={()=>{setActiv("auth")}}>
                    {authStatus ? <img className={activ==="auth" ? "full auth activee":"full auth"} src="https://img.icons8.com/ios-glyphs/30/logout-rounded-left.png"/> : <img className={activ==="auth" ? "full auth activee":"full auth"} src="https://img.icons8.com/ios-glyphs/30/login-rounded-right--v1.png"/>}
