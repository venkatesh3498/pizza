    ...
    <div className="main">
      <div className="home">
        <div className="body">
          ...
          <div className="items">
            {
              loading ? (filteredItems.length===0?<div className="diss">sorry we couldn't find any result <img src="https://img.icons8.com/ios/150/000000/disappointed--v2.png" /> </div>:""):(
